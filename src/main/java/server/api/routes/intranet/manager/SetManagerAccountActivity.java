                    ...
                    if (center == null) {
                        ...
                        if ((Boolean) received.get(Protocol.Field.IS_ACTIVE.key)) {
                            ...
                            mailContent = "Bonjour " + managerName + ",<br/><br/>" +
                                    "Votre compte a été rendu actif par " + adminName + ", gérant principal de la salle " + clubName + " !<br/><br/>" +
                            ...
                            mailContent = "Bonjour " + managerName + ",<br/><br/>" +
                                    "Votre compte a été rendu inactif par " + adminName + ", gérant principal de la salle " + clubName + ".<br/><br/>" +
