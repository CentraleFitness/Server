...
public class CustomProgramFavAdd {
    public CustomProgramFavAdd(Router router) {
        router.route(HttpMethod.POST, Protocol.Path.CUSTOMPROGRAM_FAV_ADD.path).handler(routingContext -> {
            ...
            try {
                ...
                favorites.add(new ObjectId(rCustomProgramId));
