...
public class CustomProgramGetSteps {
    public CustomProgramGetSteps(Router router) {
        router.route(HttpMethod.POST, Protocol.Path.CUSTOMPROGRAM_GET_STEPS.path).handler(routingContext -> {
