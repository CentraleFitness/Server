...
public class ChallengeInviteAnswer {
    public ChallengeInviteAnswer(Router router) {
        router.route(HttpMethod.POST, Protocol.Path.CHALLENGE_INVITE_ANSWER.path).handler(routingContext -> {
