...
public class Protocol {
	...
	public enum Path {
		...
		CHALLENGE_INVITE_ANSWER("/challenge-invite-answer"), CHALLENGE_GET_RANGE("/challenge/get"),
		CHALLENGE_COMPLETE("/challenge-complete"), CHALLENGE_QUIT("/challenge-quit"), CHALLENGE_INIT("/challenge/init"),
